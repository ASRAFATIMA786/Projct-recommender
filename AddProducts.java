...
public class AddProducts extends HttpServlet {
	private final String UPLOAD_DIRECTORY = "F:/JavaProjects/Prus/WebContent/uploads";
			...
			try {
				...
				for (FileItem item : multiparts) {
					if (!item.isFormField()) {
						...
						FileItem pcategory1 = (FileItem) multiparts.get(6);
						recategory = pcategory1.getString();
				...
				try {
					...
					int i = DatabaseConnection.insertUpdateFromSqlQuery("insert into tblproduct(id,active,code,description,image,image_name,name,price,mrp_price,product_category,product_rec) values('" + id+ "','" + status + "','"+code+"','" 
					+ descrip + "','" + imagePath + "','"+imageName+"','"+productName+"','"+productPrice+"','"+mrpPrice+"','"+category+"','"+recategory+"')");
					if (i > 0) {
