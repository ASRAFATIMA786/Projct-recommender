...
<body style="background-image: url('D:\\new workspace\\MJDM04_2023\\WebContent\\images\\mining.jpg);">
	<%
		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index-2.html"> <img
					src="WebContent/images/mining.jpg" />
				</a>
							...
							<form role="form" action="AddProducts" method="post"
								...
								<div class="form-group">
									<label>Product Category</label> <select class="form-control"
										...
										<option>Grocery Product</option>
										<!-- <option>XYZ</option> --></select>
								</div>
								<div class="form-group">
									<label>Product Reccomendation</label> <select class="form-control"
										name="recategory"><option>Select Reccom</option>
