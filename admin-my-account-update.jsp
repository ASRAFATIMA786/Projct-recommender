				...
				<div class="col-md-12">
					<div class="panel panel-info">
						...
						<%
							...
							ResultSet updateResult = DatabaseConnection.getResultFromSqlQuery("select * from tbladmin where id='" + id + "' ");
							...
							<form role="form" action="admin-my-account-update-process.jsp" method="post">
								<div class="form-group">
									<label>Id</label> <input class="form-control"
										type="text" name="aid" value="<%=updateResult.getInt("id")%>" readonly/>
								</div>
								<div class="form-group">
									<label>User Name</label> <input class="form-control"
										type="text" name="uname" value="<%=updateResult.getString("name")%>"/>
								</div>
								<div class="form-group">
									<label>Email Id</label> <input class="form-control" type="text"
										name="email" value="<%=updateResult.getString("email")%>"/>
								</div>
