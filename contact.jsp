...
<body>
	...
	<div class="header-bot">
		<div class="container">
			<div class="">
				<h3>
					<a href="index.jsp">PRUS: Product Recommender System Based on
User Specifications and Customers Reviews</a><br/>
				</h3>
			</div>
			<div class="col-md-6 header-middle">
				<form action="searchProduct.jsp" method="post" style="background-color: lightblue">
					<div class="search">
						<input type="search"  name="search" placeholder="Search Product" style="width: 680px; background-color: lightblue;">
					</div>
					<div class="sear-sub">
	...
	<!-- //header-bot -->
	<!-- banner -->
	<div class="ban-top" style="background-color: violet">
		<div class="container">
 ...
 %>
	...
	<div class="contact">
		<div class="container">
			<h3 class="tittle"  style="background-color: lightblue;">Contact Form</h3>
