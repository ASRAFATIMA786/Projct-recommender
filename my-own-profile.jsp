...
<body>
	...
	<div class="header-bot">
		<div class="container">
			<div class="">
				<h1>
					<a href="index.jsp">PERSONALITY-AWARE PRODUCT RECOMMENDATION SYSTEM BASED ON USER INTERESTS MINING AND METAPATH DISCOVERY</a>
				</h1>
			</div>
				...
				<table>
					...
					<div class="contact-form2">
						...
						<input type="email" name="email"
							...
							type="text" name="name" value="<%=rs.getString("gender")%>">
						<input type="email" name="email"
							value="<%=rs.getString("phone")%>"><br> <br> <input
							type="text" name="message" value="<%=rs.getString("address")%>"
							style="width: 1130px; height: 100px;">
					</div>
					<%
						}
					%>
