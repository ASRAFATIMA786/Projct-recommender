...
<br>
<center>
	<h1>PRUS: Product Recommender System Based on User Specifications
		and Customers Reviews</h1>
</center>
<!-- for-mobile-apps -->
...
<body>
		...
		<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/ba1.png"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/ba2.png"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/ba3.png"
						alt="Dummy Image" /></li>
				</ul>
				...
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ba1.png"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ba2.png"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/ba3.png"
									alt="Dummy Image" />
							</div></li>
					</ul>
	...
	<div class="product-easy">
		<div class="container">
			<div class="container">
				<h2>
					<span><center>Reviews</center></span>
				</h2>
			</div>
			<%
			String mainp=request.getParameter("mainp");
				ResultSet retriveProduct = DatabaseConnection.getResultFromSqlQuery("select * from tblproduct where id='"+mainp+"'");
					...
					<div class="col-md-12 product-men">
						...
						<div class="men-thumb-item">
							<input type="hidden" name="productId"
								value="<%=retriveProduct.getInt("id")%>"> <a href="">
								<div class="col-md-3 product-men">
									<img src="uploads/<%=retriveProduct.getString("image_name")%>"
										alt="" class="pro-image-front" width="200px" height="200px">
								</div> <!-- <span
									class="product-new-top">Reommended products</span></a> -->
						</div>
						<div class="item-info-product ">
							...
							<% ResultSet rs=DatabaseConnection.getReviews(retriveProduct.getInt("id")); 
								while(rs.next()){
								%>
							<div class="col-md-12 product-men" style="border: 1 solid #000;">
